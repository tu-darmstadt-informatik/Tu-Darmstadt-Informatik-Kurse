...
public class RuntimeFunctions {
	...
	public static Map<String, Function> getRuntimeFunctions(){
		...
		MatrixType matrixInt512 = MatrixType.synthesize(Type.getIntType(), 512, 512);
		MatrixType matrixInt64 = MatrixType.synthesize(Type.getIntType(), 64, 64);
		MatrixType matrixInt16 = MatrixType.synthesize(Type.getIntType(), 16, 16);
		MatrixType matrixInt9 = MatrixType.synthesize(Type.getIntType(), 9, 9);

		MatrixType matrixFloat64 = MatrixType.synthesize(Type.getFloatType(), 64, 64);
		MatrixType matrixFloat16 = MatrixType.synthesize(Type.getFloatType(), 16, 16);
		MatrixType matrixFloat9 = MatrixType.synthesize(Type.getFloatType(), 9, 9);
		/*
		 * File-I/O
		 */
