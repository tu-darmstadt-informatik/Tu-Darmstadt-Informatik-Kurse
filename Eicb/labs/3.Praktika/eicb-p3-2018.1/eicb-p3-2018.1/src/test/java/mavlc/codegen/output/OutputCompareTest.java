...
public class OutputCompareTest {
	...
	public void testExample(){
		...
		System.err.println("Compiling testcase "+testcaseName + "\n");
		ByteArrayOutputStream disasm = new ByteArrayOutputStream();
		try (PrintStream disasmStream = new PrintStream(disasm, true)) {
			Main.main(args, disasmStream);
		}
		System.err.println(disasm.toString() + "\n");
		...
		try {
			...
			sb.append("MTAM assembly:\n").append(disasm.toString()).append("\n");
