...
public class Main {
	...
	public static void main(String[] args, PrintStream disasmOutput) {
		...
		Disassembler.disassembleProgram(disasmOutput, assembler.getConstantPool(), assembler.getCode(), env.getFunctions());
