...
public class ASTVisualizerVisitor extends ASTNodeBaseVisitor<VisualizerNode, Object> {
	...
	public VisualizerNode visitType(Type type) {
		if (type instanceof VectorType) {
			VectorType vec = (VectorType)type;
			VisualizerNode vn = addNode("VECTOR", null);
			VisualizerNode elemType = visitType(vec.getElementType());
			VisualizerNode dim = vec.getDimensionExpr().accept(this, null);
			addEdge(vn, elemType);
			addEdge(vn, dim);
			return vn;
		}
		if (type instanceof MatrixType) {
			...
			VisualizerNode vn = addNode("MATRIX", null);
			VisualizerNode elemType = visitType(mat.getElementType());
			VisualizerNode xdimLabel = addNode("xDimension", null);
			VisualizerNode ydimLabel = addNode("yDimension", null);
			VisualizerNode xdim = mat.getxDimensionExpr().accept(this, null);
			VisualizerNode ydim = mat.getyDimensionExpr().accept(this, null);
			addEdge(vn, elemType);
			addEdge(vn, xdimLabel);
			addEdge(xdimLabel, xdim);
			addEdge(vn, ydimLabel);
			addEdge(ydimLabel, ydim);;
			return vn;
		}
		return addNode(type.toString(), null);
	}
	...
	public VisualizerNode visitDeclaration(Declaration declaration, Object obj) {		
		...
		VisualizerNode type = visitType(declaration.getType());
		addEdge(id, name);
		addEdge(vn, id);		
	...
	public VisualizerNode visitSingleCase(SingleCase singleCase, Object obj){
		...
		if(!singleCase.isDefault()){
			...
			VisualizerNode test = ((Case)singleCase).getConditionExpression().accept(this, null);
			addEdge(vn, test);
		}else{
